...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda2', type=float, default=5, help='the ratio of data to update controller')
        self.parser.add_argument('--lambda3', type=float, default=0, help='the ratio of data to update controller')
        ...
        self.parser.add_argument('--ctl_freq', type=int, default=10, help='the freq of update controller')
        self.parser.add_argument('--ctl_train_freq', type=int, default=10, help='the freq of update controller')
        self.parser.add_argument('--ctl_ratio', type=float, default=0.5, help='the ratio of data to update controller')
        self.parser.add_argument('--ctl_policy_num', type=int, default=2, help='the ratio of data to update controller')
        self.parser.add_argument('--ctl_update_num', type=int, default=6, help='the ratio of data to update controller')
        self.parser.add_argument('--ctl_batchSize', type=int, default=2, help='the ratio of data to update controller')
        
        self.parser.add_argument('--reward_norm', type=str, default="exp", help='mean, norm')
