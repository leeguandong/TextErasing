...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default="/home/ivms/local_disk/erase_1", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--checkpoints_dir', type=str, default="/home/ivms/local_disk/Self-supervised-Text-Erasing-main/results", help='where the model saved')
        ...
        self.parser.add_argument('--reward_type', type=str, default="24", help='how to get the reward')
        ...
        self.parser.add_argument('--valid', type=int, default=1, help='valid for evalutions')
        ...
        self.parser.add_argument('--gen_space', type=str, default='random8', help='sepcific/random1/random2/random3/random4')
