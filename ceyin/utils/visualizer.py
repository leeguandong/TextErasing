...
class Visualizer():
    def __init__(self, opt, saver=None, dist=None):
        ...
        #     self.log_name = os.path.join("gangwei.jgw/ceyin/", opt.model, opt.name, 'log', 'loss_log.txt')
        #     self.valid_log_name = os.path.join("gangwei.jgw/ceyin/", opt.model, opt.name, 'log', 'valid_loss_log.txt')
        #     self.policy_log_name = os.path.join("gangwei.jgw/ceyin/", opt.model, opt.name, 'log', 'policy_log.txt')
        #     now = time.strftime("%c")
        #     self.log_io = BytesIO()
