...
def warpGraphy(src_mat):
    ...
    if np.random.rand() > 0.75:
        pts2 = np.float32([[int(np.random.rand() / 4 * w), int(np.random.rand() / 4 * h)],
                           [int((3 / 4 + np.random.rand() / 4) * w), int(np.random.rand() / 4 * h)], \
                           [int(np.random.rand() / 4 * w), int((3 / 4 + np.random.rand() / 4) * h)],
                           [int((3 / 4 + np.random.rand() / 4) * w), int((3 / 4 + np.random.rand() / 4) * h)]])
    else:
        h = int(2.5 * h)
